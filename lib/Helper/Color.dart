...
const Color primary =Color(0xffF88C20);
const Color secondary = Color(0xff185DAB);
const Color fontColor = Colors.black;
const Color grad1Color = Color(0xffF88C20);
const Color grad2Color = Color(0xff185DAB);
